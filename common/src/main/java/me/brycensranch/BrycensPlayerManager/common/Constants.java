...
public final class Constants {
  ...
  public static final class PluginMetadata {
    ...
    // DONT FORGET TO CHANGE THIS IN BUILD-KOGIC!!!
    public static final String RELOCATION_PACKAGE_LOCATION = "me.brycensranch.BrycensPlayerManager.libs";
    public static final String GEANTYREF = "1.3.11";
  }
