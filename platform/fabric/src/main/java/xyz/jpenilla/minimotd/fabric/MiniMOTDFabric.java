...
public final class BrycensPlayerManagerFabric implements ModInitializer, BPMPlatform<String> {
  private static BrycensPlayerManagerFabric instance = null;
  ...
  public BrycensPlayerManagerFabric() {
    if (instance != null) {
  ...
  private void registerCommand() {
    final class WrappingExecutor implements Command<CommandSourceStack> {
      ...
      public int run(final @NonNull CommandContext<CommandSourceStack> context) {
        this.handler.execute(BrycensPlayerManagerFabric.this.audiences.audience(context.getSource()));
  ...
  public static @NonNull BrycensPlayerManagerFabric get() {
    return instance;
  }
